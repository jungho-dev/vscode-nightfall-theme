...
theme, and adds key/value separation plus in-string bracket emphasis that the base theme does not provide.
...
- Key/value distinction: JSON keys and JS/TS object-literal keys render blue so they no longer match their string values.
...
- 91 token color rules: 49 inherited from GitHub Dark Dimmed plus 42 project rules.
...
| Blue | `#6CB6FF` | property access, operators, JSON keys, object-literal keys |
